...
import { AppContext } from "../../AppContext";
  ...
  const AddNewDropLocation = ({navigation}) => {

    const route = useRoute();
  
    const {dropAddress, updateDropAddress} = useContext(AppContext)
    ...
    return (
      <View>
        ...
        <View style={{ flex: 0, justifyContent: "center", alignItems: "center" }}>
          <Text style={styles.title}>Add a new Drop-off Location</Text>
        </View>
        ...
        <TextInput
          style={styles.input}
          value={dropAddress}
          onChangeText={address => updateDropAddress(address)}
          placeholder="Address"
          keyboardType="characters"
        />
        <View>
  ...
  export default AddNewDropLocation;
